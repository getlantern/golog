...
{"level": "DEBUG", "component": "myprefix", "caller":"golog_test.go:999", "msg": "Hello true", "ops": {"cvarA":"a", "cvarB":"b", "op":"name", "root_op":"name"}}`
	expectedErrorLogJson = `{"level": "ERROR", "component": "myprefix", "caller":"golog_test.go:999", "msg": "Hello world\n  at github.com/getlantern/golog.TestErrorJson (golog_test.go:999)\n  at testing.tRunner (testing.go:999)\n  at runtime.goexit (asm_amd999.s:999)\nCaused by: world\n  at github.com/getlantern/golog.errorReturner (golog_test.go:999)\n  at github.com/getlantern/golog.TestErrorJson (golog_test.go:999)\n  at testing.tRunner (testing.go:999)\n  at runtime.goexit (asm_amd999.s:999)\n", "ops":{"cvarC":"c","cvarD":"d","error":"Hello %v","error_location":"github.com/getlantern/golog.TestErrorJson (golog_test.go:999)","error_text":"Hello world","error_type":"errors.Error","op":"name","root_op":"name"}}
{"level": "ERROR", "component": "myprefix", "caller":"golog_test.go:999", "msg": "Hello true\n  at github.com/getlantern/golog.TestErrorJson (golog_test.go:999)\n  at testing.tRunner (testing.go:999)\n  at runtime.goexit (asm_amd999.s:999)\nCaused by: Hello\n  at github.com/getlantern/golog.TestErrorJson (golog_test.go:999)\n  at testing.tRunner (testing.go:999)\n  at runtime.goexit (asm_amd999.s:999)\n", "ops":{"cvarA":"a", "cvarB":"b", "cvarC":"c", "error":"%v %v", "error_location":"github.com/getlantern/golog.TestErrorJson (golog_test.go:999)", "error_text":"Hello true", "error_type":"errors.Error", "op":"name999", "root_op":"name999"}}
`
